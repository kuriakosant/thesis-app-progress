      ...
      <div className="partners-content">
        ...
        <div className="partners-list">
          <div className="partner">
            ...
            <img src="/assets/amber-fabrics.png" alt="Amber Fabrics" />
          </div>
          <div className="partner">
            <div className="partner-text-box">
            ...
            <img src="/assets/future-wear.png" alt="FutureWear" />
          </div>
          <div className="partner">
            <div className="partner-text-box">
            ...
            <img src="/assets/johnson-logistics.png" alt="Johnson Logistics Inc" />
          </div>
        </div>
